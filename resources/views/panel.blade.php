...
<body>
        ...
        <div class="row">
          <div class="col s12">
            <center><a href="{{route('principal.sistema')}}" class="waves-effect waves-light btn-large red darken-1"><i class="material-icons left">local_hospital</i><b>ACCEDER</b></a></center>
          </div>
      </div>
