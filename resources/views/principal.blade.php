  ...
  <div class="row">
    <div class="col s6 m6">
      <div class="card-panel grey lighten-2">
        <center><a href="{{route('medicamentos.medicamentos')}}">  <i class="fas fa-notes-medical fa-4x" style="color: #263238 "></i> </a></center>
     ...
     <div class="container section">
      ...
      <div class="row">
        <div class="col s12 m12">
          <div class="card-panel grey lighten-2">
            <center><a href="{{route('opciones.opciones')}}">  <i class="fas fa-user-cog fa-4x" style="color: #263238"></i> </a></center>
...
<!--
  ...
  <ul class="tabs tabs-fixed-width tab-demo z-depth-1 blue-grey lighten-5">
    ...
    <li class="tab"><a href="{{route('medicamentos.medicamentos')}}">  <i class="fas fa-notes-medical fa-2x" style="color: #263238 "></i> </a></li>
