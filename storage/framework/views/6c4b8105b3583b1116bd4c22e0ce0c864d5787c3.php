...
<div class="md-form md-outline">
    ...
    <label for="inputIconEx1">Nombre Completo</label>
  ...
  <div class="md-form md-outline">
    ...
    <input type="number" id="inputIconEx1" class="form-control">
    <label for="inputIconEx1">Seguro Médico</label>
    <small id="emailHelp2" class="form-text text-muted">We'll never share your email with anyone.</small>
  </div>
  ...
  <div class="md-form md-outline">
    ...
    <input type="text" id="inputIconEx1" class="form-control">
    <label for="inputIconEx1">Historial Médico</label>
    <small id="emailHelp2" class="form-text text-muted">We'll never share your email with anyone.</small>
  </div>
...
</html><?php /**PATH C:\xampp1\htdocs\FirebaseCrud\resources\views/perfil.blade.php ENDPATH**/ ?>