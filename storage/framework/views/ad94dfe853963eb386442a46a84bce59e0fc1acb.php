   ...
   <nav class="nav-wrapper  blue-grey darken-4">
       <div class="container">
           ...
           <ul class="hide-on-med-and-down right">
               ...
               <li class="active"><a href="<?php echo e(route('cerrar.cerrar')); ?>">Cerrar Sección</a></li>
...
</html><?php /**PATH C:\xampp1\htdocs\FirebaseCrud\resources\views/empleados.blade.php ENDPATH**/ ?>